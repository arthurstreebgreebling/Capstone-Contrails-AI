...
pth = "/Users/admin/Documents/GitHub/Capstone-Contrails-AI/U-net/sandstone_data_for_ML/full_labels_for_deep_learning/128_patches/images_as_128x128_patches.tif"
img = cv2.imreadmulti(pth, flags=1)
for i in img[1]:
    train_images.append(i)


#for directory_path in glob.glob("/Users/admin/Documents/GitHub/Capstone-Contrails-AI/U-net/sandstone_data_for_ML/full_labels_for_deep_learning/128_patches/"):
#    for img_path in glob.glob(os.path.join(directory_path, "images_as_128x128_patches.tif")):
...
pth = "/Users/admin/Documents/GitHub/Capstone-Contrails-AI/U-net/sandstone_data_for_ML/full_labels_for_deep_learning/128_patches/masks_as_128x128_patches.tif"
img = cv2.imreadmulti(pth, flags=0)
for i in img[1]:
    train_masks.append(i)

#for directory_path in glob.glob("/Users/admin/Documents/GitHub/Capstone-Contrails-AI/U-net/sandstone_data_for_ML/full_labels_for_deep_learning/128_patches/"):
#    for mask_path in glob.glob(os.path.join(directory_path, "masks_as_128x128_patches.tif")):
